    ...
    <div class="wrapper">
     ...
     <div class="nNote nSuccess" id="flash">
       ...
       <span class="titleIcon">
        <input title="Select All" class="tool-tip" id="titleCheck" name="titleCheck" type="checkbox"></span>    <h6>User Management</h6></div>
       <?php if(!empty($customers)){ ?>
        ...
        <div id="dyn" class="hiddenpars">
			...
			<td><?php if(($user['User']['user_type'])==1){echo "Admin";} else if($user['User']['user_type']==2){echo "User";}  else { echo 'User'; } ?></td>
