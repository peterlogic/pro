<div class="connections index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('connectedwith'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($connection['Connection']['connectedwith']); ?>&nbsp;</td>
		<td><?php echo h($connection['Connection']['notes']); ?>&nbsp;</td>
		<td><?php echo h($connection['Connection']['status']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $connection['Connection']['id']), null, __('Are you sure you want to delete # %s?', $connection['Connection']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
