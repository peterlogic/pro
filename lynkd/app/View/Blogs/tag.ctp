	...
	<section class="mid-cnt">
		...
		<section class="mid-right">
			...
			<div class="post-home-box">
				...
				<div class="post-home-img"><?php echo $this->Html->image('../files/blogimages/'.$blog['Blog']['image'],array('alt'=>'blog_image')); ?></div>
				<?php } ?>
				<div class="post-home-content-cnt">
					...
					<div class="post-home-bottom">
						<div class="post-home-bottom-left">
							<?php echo $this->Html->link('Read more..',array('controller'=>'blogs','action'=>'view',$blog['Blog']['id'])); ?>
							<div class="time-txt"><?php echo $this->Time->timeAgoInWords($blog['Blog']['created']); ?></div>
							<?php  if($blog['Blog']['miles_difference'] !=0 ) {?>
							<div class="time-txt"><?php echo $blog['Blog']['miles_difference'].' miles'; ?></div>
							<?php } ?>
						</div>
						<div class="post-home-bottom-right">
							...
							<div id="light" class="white_content2">
								<div class="faurate">Please Login first to like this blog.. !! <?php echo $this->Html->link('Login',array('controller'=>'users','action'=>'login'),array('class'=>'login')); ?>  <a href = "javascript:void(0)" onclick = "document.getElementById('light').style.display='none';document.getElementById('fade').style.display='none'" class="change-image-close"  >Close</a></div>
							</div>
