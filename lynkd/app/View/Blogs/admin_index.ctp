     ...
     <div class="nNote nSuccess" id="flash">
       <div class="alert alert-success" style="text-align:center" ><?php echo $x; ?></div>
        ...
        <div id="dyn" class="hiddenpars">
			...
			<th><?php echo ('Created By'); ?></span></th>
			...
			<td class="center">
			 ...
			 <?php echo $this->Html->link($this->Html->image('../images/icons/admins/comment.png',array('border'=>'0','class'=>'iconb','width'=>'17')),array('action' => 'admin_comment', $user['Blog']['id']),array('class'=>'tablectrl_small bDefault tipS tool-tip','title'=>'comment','escape'=>false)); ?>
			 
            	<?php echo $this->Html->link($this->Html->image('../images/icons/admins/view.png',array('border'=>'0','class'=>'iconb','width'=>'17')),array('action' => 'admin_view_blog', $user['Blog']['id']),array('class'=>'tablectrl_small bDefault tipS tool-tip','title'=>'View','escape'=>false)); ?>
			...
			<?php echo $this->Html->link($this->Html->image('../images/icons/admins/repost.png',array('border'=>'0','class'=>'iconb','width'=>'17')),array('action' => 'admin_repost', $user['Blog']['id']),array('class'=>'tablectrl_small bDefault tipS tool-tip','title'=>'Repost','escape'=>false)); ?>
