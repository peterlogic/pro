 ...
 */
	//Configure::write('App.fullBaseUrl', 'http://dev414.trigma.us/lynkd/');
 ...
 */
	Configure::write('Security.salt', 'votingApp123');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', 'votingApp123');
...
//define('HTTP_ROOT','http://'.$_SERVER['HTTP_HOST'].'/lynkd/');